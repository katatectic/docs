...
(function($){
		...
		lazyLoad: function() {
			...
			if( lazyLoadEl.length > 0 ) {
				lazyLoadEl.each( function(){
					...
					element.attr( 'src', 'images/blank.svg' ).css({ 'background': 'url( {{ asset("public/canvas-theme/images/preloader.gif") }}) no-repeat center center #FFF' });
	...
	SEMICOLON.widget = {
		...
		notifications: function( element ){
			...
			if( !notifyMsg ) { notifyMsg = element; }
						...
						$(form).ajaxSubmit({
							...
							success: function( data ) {
								...
								if( elementAlert == 'inline' ) {
									...
									SEMICOLON.widget.notifications( data.success );
								}
